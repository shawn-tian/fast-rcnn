...
class ViDetectionData(datasets.imdb):
    def __init__(self, image_info):
        ...
        self._classes = image_info['label_set']
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._parse_roi_info(curr_image_info)
                    for curr_image_info in self._image_info['images']]
    ...
    def _parse_roi_info(self, curr_image_info):
        """
